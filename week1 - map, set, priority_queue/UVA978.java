/*
complexity - O(mlogn) where
m = number of rounds to fight to reach the end
n = number of leemings

every leeming with the same power is equal
if a leeming 50 fights a 10 it becomes equal to a 40
add his quant, then sort the leeming power (this decreases the complexity)
*/
...
class UVA978 {
	...
	/*
	logistic of a round:
	remove or decrease the quantity of the leemings prepared to fight
	after they fight, add them to a different list (to not be used again in this round)
	then re-add them again to the sorted set using addLeeming
	*/
	...
	// adds the leeming to set or increases the quantity
